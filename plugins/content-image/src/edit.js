...
<InputControl
  ...
  <div style={{ flex: '1', width: '50%' }}>
    <img src={col_image} alt={col_image_alt} style={{ width: '100%', height: 'auto' }} />
  </div>
</div>
